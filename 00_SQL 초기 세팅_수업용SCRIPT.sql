...
3. 파일 로 저장 후 SQL 실행 Ctrl + S -> Ctrl + Shift + Enter
...
대표적으로
SELECT VERSION(); 치고 컨트롤 + 엔터(한 줄 실행)으로 버전이 무사히 잘 나오면 동작하는 중임
Ctrl + Enter 하면 아래 Output에 보임
*/
-- 한 줄 주석 확인
# 한 줄 주석 확인
...
-- CREATE DATABASE IF NOT EXISTS 000000000; : 000000000의 이름의 데이터베이스 생성해라
-- 한 줄 작성 완료; : 반드시 맨 뒤에 ;(세미콜론)을 붙여야 함
*/
CREATE DATABASE IF NOT EXISTS employee_management;
/*
-- USE 000000000; : 개발자나 관리자가 사용할 데이터베이스 명칭을 선택해서 사용
-- 이 후 실행될 모든 SQL명령어는 000000000 데이터베이스에서 동작하고 작동하도록 설정
